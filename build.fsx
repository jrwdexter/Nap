...
let summary = "A short and sweet REST client."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "A short and sweet REST client."

// List of author names (for NuGet package)
let authors = [ "Jonathan Dexter" ]

// Tags for your project (for NuGet package)
let tags = "REST Fluent HTTP API JSON XML"

// File system information
let solutionFile  = "Nap.sln"
...
Target "OpenCover" (fun _ ->
  OpenCover (fun p ->
    { p with
        ...
        Filter = "+[*]*"
        WorkingDir = "./"
  }) "./tests/Nap.Tests/bin/Release/Nap.Tests.dll ./tests/Nap.Tests/bin/Release/Nap.Immutable.Tests.dll"
)

// --------------------------------------------------------------------------------------
// Upload test results to the OverallsServer
